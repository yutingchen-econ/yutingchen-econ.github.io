...
<span style="color: #6A5ACD;">An Experimental Study of Coarse Correlated Equilibrium for Delegation to Connected Autonomous Systems</span> (with [Timothy Cason](https://scholar.google.com/citations?user=NilRm5UAAAAJ))  
<strong style="color: #6252BC;"><em>Under review</em></strong>  
<div class="paper-links">
...
<span style="color: #6A5ACD;">Social Norms and Coordination in a Threshold Public Good Game with Increasing Group Size</span>  
<strong style="color: #6252BC;"><em>2025-2026 James A. Papke Graduate Fellowship Award</em></strong>  
<div class="paper-links">
<details><summary>[Abstract]</summary> Social norms can help coordinate within groups. When the group size increases with uncertainty, existing coordination may be unstable. This project employs a laboratory experiment to investigate the persistence of social norms and their influence on coordination behaviors in a threshold public good game with increasing group size. Participants will first choose one of two norms. They will then be randomly assigned a role and put into a group of four. A group starts with one member, and a new member joins with a 25% chance until the group size reaches 4. Members A and B agree on the same norm in treatment groups, while A and B differ in norm choices in control groups. C and D's norm choices are unknown in both cases. In each round, current members participate in a public goods game with a threshold of one investment, while observers remain inactive. There are four main findings of this experiment. First, there's no significant difference in the provision rates of public goods between the treatment groups and the control groups. Second, the persistence rates of both norms start higher in treatment groups but decline more rapidly when group size increases than those of the control groups. Third, the overinvestment rate increases with group size, and it is higher when conditional on no investment in the previous round. Last but not least, different response rates among group members are the key reason why a social norm persists for a shorter time. For a social planner who aims to establish a social norm that helps people coordinate as the group expands, it must be a good norm in the sense that people accept it at a similar level, so that it can persist longer.</details>
<details><summary><a href="/Threemonks_0407.pdf">[2025 wp]</a></summary></details>
</div>
...
<span style="color: #6A5ACD;">Bragging or Being Modest? An Experimental Study on Perceived Value of Skills</span> (with [Jinyuqi Huang](https://scholar.google.com/citations?user=QUsJSvMAAAAJ) and [Béla Elmshauser](https://scholar.google.com/citations?user=aBrd2tgAAAAJ))

</div>

<div style="margin-bottom: 1.5rem;">

<span style="color: #6A5ACD;">Doomsday Impacts Under Uncertainty</span> (with [Prerana Maheshwari](https://www.prerana-maheshwari.com/) and [Talha Cakir](https://www.talhacakir.com/))
